 ...
 *
 * @param el$ A DOM source created from DOM.select('css-selector')
 * @param initialValue Initial value to emit on the special `value$` stream
 * @returns Collection of event streams ready for mapping to actions
 */
