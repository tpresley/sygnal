...
export const nullv = (v: any): v is null => v === null

export const undefinedv = (v: any): v is undefined => v === undefined

export const number = (v: any): v is number => typeof v === 'number'

export const string = (v: any): v is string => typeof v === 'string'

export const text = (v: any): v is string | number => string(v) || number(v)

export const array = (v: any): v is any[] => Array.isArray(v)

export const object = (v: any): v is Record<string, any> => typeof v === 'object' && v !== null

export const fun = (v: any): v is Function => typeof v === 'function'

export const vnode = (v: any): boolean => object(v) && 'sel' in v && 'data' in v && 'children' in v && 'text' in v

const svgPropsMap: Record<string, number> = {
...
export const svg = (v: any): boolean => v.sel in svgPropsMap
